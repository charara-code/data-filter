...
def create_cli():
    ...
    while True:
        ...
        parser.add_argument('--version', action='version', version='Data Filter CLI 1.0')
        ...
        filter_parser.add_argument('--comparison', type=str, choices=['eq', 'lt', 'gt'], default='eq', help='Comparison type')
        ...
        if args.command is None:
            ...
            if args.command == 'load':
                ...
                if data is None:
                    ...
                    sort_data(data, loader_name=file_type, key=args.key, reverse=args.reverse)
                    ...
                    try:
                        ...
                        try:
                            ...
                            if args.value.lower() == 'true':
                                ...
                                value = args.value
                    filter_data(data, loader_name=file_type, column=args.column, value=value, comparison=args.comparison)
...
def load_data(file_path):
    ...
    try:
        ...
        data_loader = Factory.get_data_loader(loader_name=loader_name, data_source=file_path)
